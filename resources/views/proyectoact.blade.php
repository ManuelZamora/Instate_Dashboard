...
<body>
    ...
    <script>
        ...
        function initMap() {
            ...
            function fillInAddress(place) { // optional parameter
                ...
                var estados = [{
                    "Baja California": ["Tijuana", "lipsi"]
                }, {
                    "Baja California2": ["Tijuana2", "lipsi 2"]
                }]
    ...
    <div class="form1">
        ...
        <form method="POST" action="https://instatecommx.activehosted.com/proc.php" id="_form_33_" class="_form _form_33 _inline-form  _dark" novalidate>
            ...
            <input type="hidden" name="or" value="caca5d136f3c7d1d8f781d9573feb160" />
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="_form_element _field38 _full_width ">
                                            ...
                                            <div class="_field-wrapper">
                                                <select class="form-control" name="field[38]" id="field[38]" required>
                                                    <option selected>
                                                    </option>
                                                    <option value="Residencia">
                                                        Residencia
                                                    </option>
                                                    <option value="Nave insdustrial">
                                                        Nave insdustrial
                                                    </option>
                                                    <option value="Plaza comercial">
                                                        Plaza comercial
                                                    </option>
                                                    <option value="Edificio departamento">
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="_form_element _field39 _full_width " id="np">
                                            <label for="field[39]" class="_form-label">
                                                numero de piso
                                            </label>
                                            <div class="_field-wrapper">
                                                <input  class="form-control" type="text" id="field[39]" name="field[39]" value="" placeholder="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="graci">
        <div class="row">
            <div class="com-md-4">
                <h3>¡Gracas por subcribirse dentro de poco recibira un correo con mas informacion!</h3>
            </div>
        </div>
    </div>
...
<script>
  ...
  if(this.value=="Edificio departamento"){
    $("#np").show();
