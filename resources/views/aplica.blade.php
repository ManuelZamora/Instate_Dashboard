    ...
    function fillInAddress(place) { // optional parameter
      ...
      for (const component of componentForm) {
        ...
        if (component !== 'location') {
          console.log("asdasd");
          console.log(getAddressComp(component));
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="responsive">
        ...
        <div class="row">
          <div class="col-md-12">
            <!--aqui va los datos de la persona -->
            <section class="datos_personas">
            ...
            <!--aqui va los datos del mapa -->
            <section class="datos_mapa">
              <h3>Ingrese la unicacion en la que desea trabajar</h3>
              <div class="row">
                <div class="col-md-12">
            ...
            <!--aqui va los datos del mata y mts2-->
