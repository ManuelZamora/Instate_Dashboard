<style>
    ...
    #_form_25_ ._x75767881 ._form-title {
        font-size: 20px;
    }

    #_form_25_ ._x40277765 {
        margin-top: -5px;
        margin-bottom: 15px;
    }

    #_form_25_ ._x07957146 input {
        margin-top: 32px;
    }

    #_form_25_ ._x21160663 ._form-title {
        font-size: 20px;
    }
</style>
...
<form method="POST" action="https://instatecommx.activehosted.com/proc.php" id="_form_25_" class="_form _form_25 _inline-form  _dark" novalidate>
    ...
    <input type="hidden" name="or" value="c319424f70073e9f8db428eaad902c0b" />
    <div class="_form-content">
        ...
        <div class="_form_element _x11484689 _full_width _clear">
            <div class="_html-code">
                <p>
                    <br>
                    <br>
