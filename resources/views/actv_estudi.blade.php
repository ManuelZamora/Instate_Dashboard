<style>
  ...
  #_form_29_ ._x75767881 ._form-title {
    font-size: 20px;
  }

  #_form_29_ ._x40277765 {
    margin-top: -5px;
    margin-bottom: 15px;
  }

  #_form_29_ ._x07957146 input {
    margin-top: 32px;
  }

  #_form_29_ ._x21160663 ._form-title {
    font-size: 20px;
  }
</style>
<link href="https://fonts.googleapis.com/css2?family=Lato&family=Montserrat&family=Roboto&display=swap" rel="stylesheet">
<form method="POST" action="https://instatecommx.activehosted.com/proc.php" id="_form_29_" class="_form _form_29 _inline-form  _dark" novalidate>
  ...
  <input type="hidden" name="or" value="85a92eaaabb45851758d8a59e3a1dd27" />
  ...
  <div class="_form-content">
    ...
    <div class="_form_element _field27 _full_width ">
      ...
      <div class="_field-wrapper">
        <input type="text" id="field[27]" name="field[27]" value="" placeholder="Apellido" />
      </div>
    </div>
    ...
    <div class="_form_element _field28 _full_width ">
      ...
      <div class="_field-wrapper">
        <input type="text" id="field[28]" name="field[28]" value="" placeholder="Número de whatsapp" />
      </div>
    </div>
    <div class="_form_element _field24 _full_width ">
      ...
      <div class="_field-wrapper">
        <input type="text" id="field[24]" name="field[24]" value="" placeholder="Tu ciudad de residencia" />
      </div>
    </div>
    <div class="_form_element _x60140171 _full_width _clear">
      <div class="_html-code">
        <p style="color:#787878; opacity:0.7">
          <strong>
            Quiero conocer sus posibilidades de uso de suelo y
    ...
    <div class="_form_element _x75767881 _full_width _clear">
      <div class="_form-title">
        Ahora hablemos del terreno de tu futuro negocio.
      </div>
    </div>
    <div class="_form_element _field17 _full_width ">
      ...
      <div class="_field-wrapper">
        <input type="text" id="field[17]" name="field[17]" value="" placeholder="Calle" />
      </div>
    </div>
    <div class="_form_element _field18 _full_width ">
      ...
      <div class="_field-wrapper">
        <input type="text" id="field[18]" name="field[18]" value="" placeholder="Número" />
      </div>
    </div>
    <div class="_form_element _field23 _full_width ">
      ...
      <div class="_field-wrapper">
        <input type="text" id="field[23]" name="field[23]" value="" placeholder="Colonia" />
      </div>
    </div>
    <div class="_form_element _field21 _full_width ">
      ...
      <div class="_field-wrapper">
        <input type="text" id="field[21]" name="field[21]" value="" placeholder="Ciudad" />
      </div>
    </div>
    <div class="_form_element _field25 _full_width ">
      ...
      <div class="_field-wrapper">
        <input type="text" id="field[25]" name="field[25]" value="" placeholder="Estado" />
      </div>
    </div>
    <div class="_form_element _field22 _full_width ">
      ...
      <div class="_field-wrapper">
        <input type="text" id="field[22]" name="field[22]" value="" placeholder="CP" />
      </div>
    </div>
    ...
    <div class="_form_element _field30 _full_width ">
      ...
      <div class="_field-wrapper">
        <input type="text" id="field[30]" name="field[30]" value="" placeholder="Frente" />
      </div>
    </div>
    <div class="_form_element _field31 _full_width ">
      ...
      <div class="_field-wrapper">
        <input type="text" id="field[31]" name="field[31]" value="" placeholder="Largo" />
      </div>
    </div>
